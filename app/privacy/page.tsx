        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto bg-white p-8 rounded-xl shadow-sm border border-slate-200">
            ...
            <div className="prose prose-slate max-w-none">
              ...
              <p>
                Welcome to Dream Sales Jobs. We respect your privacy and are committed to protecting your personal data.
              ...
              <h2>5. Contact Us</h2>
              <p>
                If you have any questions about this privacy policy or our privacy practices, please contact us at: support@dreamsalesjobs.com
              </p>
            </div>
          </div>
        </div>
